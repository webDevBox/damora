...
<body class="buyer_body" id="body" onload="">
    <div class="row">
        <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
            ...
            <br>
            <a href="{{route('add_credit')}}"> <h5 class="text-success text-center" >  {{$credit}} Credits  </h5> </a>
            <hr class="hr">
            <a href="{{route('buyerdash')}}" class="text-left">  <h5 style="font-weight: normal" class=" nav-side"> 
                <i class="fa fa-tachometer" aria-hidden="true"></i> Dashboard </h5>
            </a>
            
        <a href="{{route('buyer_researcher')}}" class="text-left">  <h5 style="font-weight: normal" class=" nav-side"> 
        ...
        <a href="{{route('services')}}" class="text-left">  <h5 style="font-weight: normal" class=" nav-side"> 
            ...
            <a href="{{route('chat_page')}}" class="text-left">  <h5 style="font-weight: normal" class=" nav-side"> 
                ...
                @if($side_notify > 0) <p class="dot ">{{$side_notify}}</p> @endif
            </h5>
            </a>
            
            <a href="{{route('buyer_profile')}}" class="text-left">  <h5 style="font-weight: normal" class=" nav-side"> 
