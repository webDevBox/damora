...
<h1 class="text-center text-white mt-100"> Login </h1>
...
@endif 
    <div class="row">
        ...
        <form action="{{route('signin')}}" method="POST" class="form">
            ...
            <p class="text-dark text-center mt-2 mb-2"> If New User then/<span class="text-success" id="register" style="cursor:pointer;">Register</span> </p>
            </form>
        </div>
    </div>
</div>
