    ...
    <body style="background-image: url('img/register-bg.png');background-repeat: no-repeat;background-size: cover; overflow-x: hidden;" class='img-responsive'>
        ...
        <div class="row mt-5">
            ...
            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 blocker" style="background: #ECBE44; height:600px; margin-left: 10px;">
                    ...
                    <form action="{{route('signin')}}" method="POST" class="form container">
                        <h2 class="container">Login Your Account</h2>
                        <br>
                        @csrf
                            ...
                            @if ($errors->has('type')) <p style="color:red;">{{ $errors->first('type') }}</p> @endif 
                                <br><br>
                                <center>
                              <input type="submit" name="submit" value="Login" class="btn btn-dark d-block">
                            </center>
                        <p class="text-dark text-center mt-2 mb-2"> If New User then/<span class="text-dark" id="log" style="cursor:pointer;">Register</span> </p>
                        </form>
