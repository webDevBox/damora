...
$(document).ready(function (e) {
  $(".navbar ul li a, ul.links a, .side-nav li a").click(function () {
    $(".navbar ul li").removeClass("active");
    $("ul.links li").removeClass("active");
    $(this).parent().addClass("active");
    t = 1;
    hdrHeight = $(".navbar").height();
    var e = $(this).attr("href");
    if (e === "index.html") {
      $("html, body").animate({ scrollTop: 0 }, 800), !1;
      return false;
    }
    a = $(e).offset().top - hdrHeight + 45;

    return $("html, body").animate({ scrollTop: a }, 800), !1;
  });
});
